...
from local_settings import LANG_MODEL_DIR, TEXT_DIR, LANG_MODEL_DIR, \
    make_model_fname

from utils import num_wiggle, parse_weight_string, weighted_avg, join_dicts, retokenize
...
class SpeechWriter(object):
    ...
    def generate_speech(self, id_weight_string, persist=False, key=None,
            citations=False):
